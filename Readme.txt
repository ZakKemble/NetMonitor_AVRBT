...
./router/btnetmon
This is the main program which runs on the router, the binary was compiled on Debain 6.0.4 x64 so it
may or may not work without having to recompile (differently named libs, etc). To build you will need
gcc, libcurl-devel and liboping-devel.
